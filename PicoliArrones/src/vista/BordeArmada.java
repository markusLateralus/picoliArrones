...
//		this.ejercitoInfo=Generador.getEjercitoInfo( pobladorController.getEjercito());
	...
	public void cargarEjercito(EjercitoInfo ejercitoInfo) {
		...
		lblCurrentBattalionId = new JLabel(String.valueOf(ejercitoInfo.getIdBatallonActual()));
	...
	public void update(EjercitoInfo armyInfo) {
		...
		lblCurrentBattalionId.setText(String.valueOf(armyInfo.getIdBatallonActual()));
	}
