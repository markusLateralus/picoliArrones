...
//	private LinkedList<Batallon> batallones;
	...
	public MercadoSoldadoDialog(MercadoSoldados mercadoSoldados) {
		...
		//this.mercadoTipo=mercadoTipo;
		//int id = Integer.parseInt(mercadoSoldados.getId());//mercadoTipo.getTextFieldId().getText());
		mercadoSoldados = this.mercadoSoldados;
...
//						}
//						else {
//							getLblTotal().setText("cantidad no válida");
//						}
//					}
//				});
			}
	...
	public JLabel getLblTotal() {
		return mercadoSoldados.getLblTotal();
	}
